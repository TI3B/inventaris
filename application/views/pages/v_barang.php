<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            <a class="btn btn-mini" href="<?php echo site_url('barang/hapus_barang/'.$row->kd_barang);?>"
...
<div id="modalAddBarang" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo site_url('barang/tambah_barang')?>">
...
if (isset($data_barang)){
    foreach($data_barang as $row){
        ...
        <div id="modalEditBarang<?php echo $row->kd_barang?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('barang/edit_barang')?>">
                <div class="modal-body">
                    <div class="control-group">
                        <label class="control-label">Kode Barang</label>
                        <div class="controls">
