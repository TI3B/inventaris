                ...
                <div class="container">
                    <ul class="nav">
                        ...
                        <li class="<?php if(isset($active_barang)){echo $active_barang ;}?>">
                            <a href="<?php echo site_url('barang')?>"><i class="icon-barcode"></i> Barang Kamar</a></li>
                            
                            <li class="<?php if(isset($active_baranggudang)){echo $active_baranggudang ;}?>">
                            <a href="<?php echo site_url('barang_gudang')?>"><i class="icon-barcode"></i> Barang Gudang</a></li>

                        <!-- <li class="<?php if(isset($active_penjualan)){echo $active_penjualan ;}?>">
                            <a href="<?php echo site_url('penjualan')?>"><i class="icon-barcode"></i> Pembelian</a></li> -->
